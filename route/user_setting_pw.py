...
def user_setting_pw():
    with get_db_connect() as conn:
        ...
        if flask.request.method == "POST":
            ...
            curs.execute(
                db_change("select data from user_set where id = ? and name = 'encode'"),
                [ip],
            )
            db_data = curs.fetchall()
            if not db_data:
            ...
            return easy_minify(
                flask.render_template(
                    ...
                    <form method="post">
                        <input placeholder="'''
                    + load_lang("now_password")
                    + '''" name="password_now" type="password">
                        <hr class="main_hr">
                    ...
                    + """" name="password_new_repeat" type="password">
                        <hr class="main_hr">
