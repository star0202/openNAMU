        ...
        if flask.request.method == "POST":
            if admin_check(None, "bbs_set (acl)") != 1:
                ...
                for i in i_list:
                    curs.execute(
                        db_change(
                            "update bbs_set set set_data = ? where set_name = ? and set_id = ?"
                        ),
                        [
            ...
            return easy_minify(
                flask.render_template(
                    ...
                    <form method="post">
                        ...
                        <h5>"""
                        + load_lang("bbs_comment_acl")
                        + """</h5>
                        <select """
                        + disable
                        + """ name="bbs_comment_acl">"""
                        + acl_div[2]
                        + """</select>
